...
target_url  = ['http://sis-db-04/SOATReportConsole/InformesHistoricos/GeneradorInformes.aspx?Rpt=81']
...
def loginpage():
    ...
    login.clear()
    login.send_keys("equintero")
    time.sleep(10)
    pwd = driver.find_element(By.ID, "txtpassword")
    pwd.clear()
    pwd.send_keys("MgLKvAGOHi")
...
def descargarvida():
    ...
    try:
        ...
        logging.error('Error al descargarvida el archivo de la consola de consultas')
